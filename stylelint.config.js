	...
	overrides: [
		{
			...
			// sugarss merges consecutive `&__a` / `&__b` lines into one selector; @stylistic
			// combinator rules then rewrite newlines to spaces (e.g. `&__test &__test-item`).
			rules: {
		...
		},
		{
			files: ['**/*.{vue,html}'],
			customSyntax: syntax,
			// Embedded `lang="sass"` uses sugarss; same BEM/selector fix as `**/*.sass` (see above).
			rules: {
				'@stylistic/selector-combinator-space-after': null,
				'@stylistic/selector-combinator-space-before': null,
				'@stylistic/selector-descendant-combinator-no-non-space': null,
